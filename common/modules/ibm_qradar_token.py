...
class IBMQradarToken:
    def __init__(self, api_key: str, ip_address: str, port: int):
        """
        Constructor for IBMQradarToken class.

        :param api_key: The API key to use when logging into the QRadar.
        :param ip_address: The IP address of the QRadar instance.
        :param port: The port number of the QRadar instance.
        :raises ValueError: If either the api_key, ip_address or port are not set.
        """
        self.ip_address = ip_address
        self.port = port
        self.api_key = api_key
        if not self.api_key or not self.ip_address or not self.port:
            logger.error("IBM QRadar both api_key, ip_address and port are required")
            raise ValueError("Both api_key, ip_address and port are required")

        self.base_url = self.get_base_url()
        self.headers = {"SEC": self.api_key}
    ...
    def __enter__(self):
        ...
        logger.info(f"Logging into IBM QRadar with api_key: {self.api_key}")
        return self
    ...
    def __exit__(self, exc_type, exc_value, traceback):
        ...
        """
        logger.info("Logging out of IBM QRadar Token based")
    ...
    def test_integration(self, timeout=SSLConstants.TIMEOUT):
        ...
        using the credentials and base URL set in the IBMQradarToken class. It uses HTTP basic
        ...
        try:
            ...
            data = response.json()
            logger.success(
                f"IBMQRadarToken.test_integration() took: {time.time() - start} seconds"
            )
            return data
    ...
    def _get_tenants(self):
        ...
        try:
            ...
            logger.success(
                f"IBMQRadarToken._get_tenants() took: {time.time() - start} seconds"
            )
            return tenants
    ...
    def _get_domains(self):
        ...
        try:
            ...
            logger.success(
                f"IBMQRadarToken._get_domains() took: {time.time() - start} seconds"
            )
            return domains
    ...
    def _get_event_collectors(self):
        ...
        try:
            ...
            logger.success(
                f"IBMQRadarToken._get_event_collectors() took: {time.time() - start} seconds"
            )
    ...
    def _get_log_sources_types(self):
        ...
        try:
            ...
            logger.success(
                f"IBMQRadarToken._get_log_sources_types() took: {time.time() - start} seconds"
            )
    ...
    def _get_log_sources_groups(self):
        ...
        try:
            ...
            log_sources_types = response.json()
            logger.success(
                f"IBMQRadarToken._get_log_sources_groups() took: {time.time() - start} seconds"
            )
            return log_sources_types
    ...
    def _get_event_logs(self):
        ...
        try:
            ...
            logs = response.json()
            logger.success(
                f"IBMQRadarToken._get_event_logs() took: {time.time() - start} seconds"
            )
            return logs
    ...
    def _insert_domains(self, data):
        ...
        """
        start = time.time()
        logger.info(f"IBMQRadarToken._insert_domains() started : {start}")
        ...
        try:
            with transaction.atomic():
                ...
                logger.success(
                    f"IBMQRadarToken._insert_domains() took: {time.time() - start} seconds"
                )
        except Exception as e:
            logger.error(
                f"An error occurred in IBMQradarToken._insert_domains(): {str(e)}"
            )
            transaction.rollback()
    ...
    def _insert_event_collectors(self, data):
        ...
        """
        start = time.time()
        logger.info(f"IBMQRadarToken._insert_event_collectors() started: {start}")
        ...
        try:
            ...
            logger.success(
                f"IBMQRadarToken._insert_event_collectors() took: {time.time() - start} seconds"
            )
        except Exception as e:
            logger.error(
                f"An error occurred in IBMQradarToken._insert_event_collectors(): {str(e)}"
            )
            transaction.rollback()
    ...
    def _delete_stale_event_logs(self, api_data, integration_id):
        ...
        """
        start = time.time()
        logger.info(f"IBMQRadarToken._delete_stale_event_logs() started: {start}")
        ...
        logger.success(
            f"IBMQRadarToken._delete_stale_event_logs() took: {time.time() - start} seconds"
        )
    ...
    def _insert_event_logs(self, data):
        ...
        """
        start = time.time()
        logger.info(f"IBMQRadarToken._insert_event_logs() started: {start}")
        ...
        try:
            ...
            logger.success(
                f"IBMQRadarToken._insert_event_logs() took: {time.time() - start} seconds"
            )
        except Exception as e:
            logger.error(
                f"An error occurred in IBMQradarToken._insert_event_logs(): {str(e)}"
            )
            transaction.rollback()
    ...
    def _get_offenses(self):
        ...
        """
        start = time.time()
        logger.info(f"IBMQRadarToken._get_offenses() started: {start}")
        ...
        try:
            ...
            logger.success(
                f"IBMQRadarToken._get_offenses() took: {time.time() - start} seconds"
            )
            return response
        except Exception as e:
            logger.error(
    ...
    def _transform_offenses(self, data, integration_id):
        ...
        """
        start = time.time()
        logger.info(f"IBMQRadarToken._transform_offenses() started: {start}")
        ...
        logger.success(
            f"IBMQRadarToken._transform_offenses() took: {time.time() - start} seconds, transformed {len(records)} offenses"
        )
    ...
    def _insert_offenses(self, transformed_data):
        ...
        """
        start = time.time()
        logger.info(f"IBMQRadarToken._insert_offenses() started: {start}")
        ...
        try:
            ...
            logger.success(
                f"IBMQRadarToken._insert_offenses() took: {time.time() - start} seconds"
            )

        except Exception as e:
            logger.error(
                f"An error occurred in IBMQRadarToken._insert_offenses(): {str(e)}"
            )
            transaction.rollback()
    ...
    def _insert_log_sources_types(self, data):
        ...
        """
        start = time.time()
        logger.info(f"IBMQRadarToken._insert_log_sources_types() started : {start}")
        ...
        try:
            with transaction.atomic():
                ...
                logger.info(f"Inserted the domains records: {len(records)}")
                logger.success(
                    f"IBMQRadarToken._insert_log_sources_types() took: {time.time() - start} seconds"
                )
        except Exception as e:
            logger.error(
                f"An error occurred in IBMQRadarToken._insert_log_sources_types(): {str(e)}"
            )
            transaction.rollback()
    ...
    def _insert_high_level_category_counts(self, data):
        ...
        start = time.time()
        logger.info(
            f"IBMQRadarToken._insert_high_level_category_counts() started at: {start}"
        )
        ...
        try:
            ...
            logger.info(
                f"IBMQRadarToken._insert_high_level_category_counts() took: {time.time() - start:.2f} seconds"
            )
        except Exception as e:
            logger.error(
                f"Error in IBMQRadarToken._insert_high_level_category_counts(): {str(e)}"
            )
    ...
    def _insert_eps(self, data):
        ...
        """
        start = time.time()
        logger.info(f"IBMQRadarToken._insert_eps() started at: {start}")
        ...
        try:
            ...
            logger.success(
                f"IBMQRadarToken._insert_eps() took: {time.time() - start:.2f} seconds"
            )
        except Exception as e:
    ...
    def _insert_daily_eps(self, data):
        ...
        """
        start = time.time()
        logger.info(f"IBMQRadarToken._insert_daily_eps() started at: {start}")
        ...
        try:
            ...
            logger.info(f"Inserted EPS records: {len(data)}")
            logger.success(
                f"IBMQRadarToken._insert_daily_eps() took: {time.time() - start:.2f} seconds"
            )
        except Exception as e:
            logger.error(
                f"An error occurred in IBMQRadarToken._insert_daily_eps(): {str(e)}"
            )
            transaction.rollback()
    ...
    def _insert_total_events(self, data_list):
        ...
        """
        start = time.time()
        logger.info(f"IBMQRadarToken._insert_total_events() started: {start}")
        ...
        try:
            with transaction.atomic():
                ...
                logger.info(
                    f"IBMQRadarToken._insert_total_events() took: {time.time() - start:.2f} seconds"
                )
        except Exception as e:
    ...
    def update_asset_active_status(self, integration_id):
        ...
        start = time.time()
        logger.info(
            f"IBMQRadarToken.update_asset_active_status() started for integration {integration_id}"
        )
        ...
        try:
            ...
            logger.info(
                f"IBMQRadarToken.update_asset_active_status() took {time.time() - start} seconds"
            )
