...
class RBACConstants:
    SUPER_ADMIN_GROUP = "CSOC_SOAR_ADMIN"
    ADMIN_GROUP = "CSOC_SOAR_SR_SECURITY_ANALYST"
    READ_ONLY_USER_GROUP = "CSOC_SOAR_ANALYST"
