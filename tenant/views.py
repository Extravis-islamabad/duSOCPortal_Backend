...
from tenant.ibm_qradar_tasks import sync_ibm_tenant_daily_eps_token
...
class DuITSMTenantsListView(APIView):
    ...
    def get(self, request):
        ...
        try:
            ...
            tenants = DuITSMTenants.objects.filter(integration_id=integration_id)
...
class DuCortexSOARTenantsListView(APIView):
    ...
    def get(self, request):
        ...
        try:
            # Filter tenants by integration_id
            tenants = DuCortexSOARTenants.objects.filter(integration_id=integration_id)
...
class TestView(APIView):
    ...
    def get(self, request):
        ...
        #     print(data)
        sync_ibm_tenant_daily_eps_token()
