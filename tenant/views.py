        ...
        try:
            ...
            response_data = {
                level.label: {
                    ...
                    "tta_sla_minutes": sla_metrics_dict.get(level, {}).tta_minutes if sla_metrics_dict.get(level) else None,
                    "ttn_sla_minutes": sla_metrics_dict.get(level, {}).ttn_minutes if sla_metrics_dict.get(level) else None,
                    "ttdn_sla_minutes": sla_metrics_dict.get(level, {}).ttdn_minutes if sla_metrics_dict.get(level) else None,
                }
                for level in [
                    SlaLevelChoices.P1,
                    SlaLevelChoices.P2,
            ...
            for inc in incidents:
                ...
                for slevel in [SlaLevelChoices.P1, SlaLevelChoices.P2, SlaLevelChoices.P3, SlaLevelChoices.P4]:
